...
3. **No Wikidata entry found for 'Sekar Bali Activity'.**
   - Priority: `Info`
   - Area: `Wikidata`
   - Evidence: See audit output.
...
4. **No Wikipedia article found for 'Sekar Bali Activity'.**
   - Priority: `Info`
   - Area: `Wikipedia`
   - Evidence: See audit output.
