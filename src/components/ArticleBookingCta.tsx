...
const CTA_BY_SLUG: Record<string, ArticleCta> = {
  ...
  'rafting-ubud-price-2026': {
    headline: 'Book Ayung rafting at the published IDR',
    body: 'IDR 500,000, or IDR 450,000 for 2+ (min 2). Lunch included. Pickup IDR 400,000 or self-meet. No payment to inquire.',
    primaryHref: '/tours/whitewater-rafting',
    primaryLabel: 'Book rafting',
    secondaryHref: '/blog/wos-river-tubing-price-2026',
    secondaryLabel: 'Compare Wos tubing price',
  },
  ...
  'wos-river-tubing-price-2026': {
    headline: 'Book Wos River tubing at the published IDR',
    body: 'IDR 500,000, or IDR 450,000 for 2+. Lunch not included. Pickup IDR 400,000 or self-meet. No payment to inquire.',
    primaryHref: '/tours/canyon-tubing',
    primaryLabel: 'Book tubing',
    secondaryHref: '/tours/bali-atv-adventure',
    secondaryLabel: 'Add ATV first',
  ...
  'tirta-empu-melukat-ubud-guide': {
    ...
    secondaryHref: '/tours/balinese-cooking-class',
    secondaryLabel: 'Add afternoon cooking',
  },
  ...
  'ubud-travel-guide-escape-crowds-2026': {
    ...
    primaryLabel: 'Book cycling',
    secondaryHref: '/tours/balinese-cooking-class',
    secondaryLabel: 'Book Tumang cooking',
  },
  'morning-vs-afternoon-tours-bali': {
    headline: 'Morning ride or afternoon kitchen',
    body: 'Cycling is cooler before 10:00. Tumang cooking is the slower afternoon slot. Promo IDR 450,000 with free Ubud pickup.',
    primaryHref: '/tours/ubud-ricefield-cycling-tour',
    primaryLabel: 'Book morning cycling',
    secondaryHref: '/tours/balinese-cooking-class',
    secondaryLabel: 'Book afternoon cooking',
  },
  'best-time-to-visit-bali': {
    headline: 'Lock a dry-season Ubud day',
    body: 'Private full-day car from IDR 600,000. Entrance fees and lunch not included. WhatsApp the date — no payment to inquire.',
    primaryHref: '/tours/full-day-ubud-tour',
    primaryLabel: 'View full-day tour',
    secondaryHref: '/experiences',
  ...
  'how-to-get-around-ubud': {
    headline: 'Skip the scooter — book a private car day',
    body: 'Full-day Ubud tour from IDR 600,000, or a DPS → Ubud transfer from IDR 700,000. We handle traffic and parking.',
    primaryHref: '/tours/full-day-ubud-tour',
    primaryLabel: 'View full-day tour',
    secondaryHref: '/transfers',
    secondaryLabel: 'Airport transfer',
  },
  'authentic-balinese-village-etiquette-for-travelers': {
    headline: 'Visit Pejeng with a local host',
    body: 'Cycling through village lanes, or cook in a family paon. Hosts brief you on offerings, shoes, and temple dress.',
    primaryHref: '/tours/ubud-ricefield-cycling-tour',
    primaryLabel: 'Book Pejeng cycling',
    secondaryHref: '/tours/balinese-cooking-class',
    secondaryLabel: 'Book Tumang cooking',
  ...
  'bali-safari-packages-compared-2026': {
    headline: 'Pick Hopper, Dragon, Leopard, or Rhino',
    body: 'We book the park ticket — from IDR 1,000,000 Jungle Hopper to IDR 2,300,000 Rhino. Hotel pickup is quoted.',
    primaryHref: '/tours/bali-safari-and-marine-park',
    primaryLabel: 'View Safari packages',
    secondaryHref: '/blog/bali-zoo-vs-bali-safari-vs-taro',
    secondaryLabel: 'Zoo vs Safari vs Taro',
  },
  'bali-zoo-vs-bali-safari-vs-taro': {
    headline: 'Book the right elephant park',
    body: 'Three venues. Zoo mud fun from IDR 1,850,000, Safari from IDR 1,000,000, Taro ride+lunch from IDR 1,665,000. Pickup quoted.',
    primaryHref: '/tours/bali-safari-and-marine-park',
    primaryLabel: 'View Safari packages',
    secondaryHref: '/tours/elephant-mud-fun-at-bali-zoo-park',
  ...
  'ubud-workshop-classes-2026': {
    ...
    secondaryLabel: 'View silver class',
  },
  'kintamani-dirt-bike-vs-batur-jeep': {
    ...
    secondaryLabel: 'View Kintamani dirt bike',
  },
  'bali-bird-park-from-ubud-2026': {
    headline: 'Book Bali Bird Park from Ubud',
    body: 'Batubulan admission from IDR 585,000. Shows follow the park clock. Hotel pickup is quoted — we book the ticket.',
    primaryHref: '/tours/bali-bird-park',
    primaryLabel: 'View Bird Park',
    secondaryHref: '/blog/bali-zoo-vs-bali-safari-vs-taro',
    secondaryLabel: 'Compare the parks',
  },
}
