...
export default function BookingForm({ tour }: Props) {
  ...
  if (serverResult?.success) {
    return (
      <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-3xl p-8 text-center space-y-4 shadow-sm">
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-150 dark:border-gray-800 p-6 md:p-8">
      ...
      <div className="flex items-center justify-between mb-8 relative">
        ...
        <div 
          className="absolute left-0 top-1/2 -translate-y-1/2 h-0.5 bg-emerald-500 rounded-full z-0 transition-all duration-300"
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 rounded-2xl border text-left cursor-pointer transition-all duration-200 flex items-start gap-3 select-none hover:-translate-y-0.5 hover:shadow-sm ${
                            isSelected
                              ? 'border-emerald-500 bg-emerald-500/[0.03] dark:bg-emerald-950/[0.08] ring-1 ring-emerald-500/25'
                              : 'border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:border-emerald-300 dark:hover:border-emerald-800'
                          }`}
                        >
                          {/* Radio circle */}
                ...
                <div className="mt-2 text-xs flex items-center gap-1.5">
                  {checkingAvailability ? (
                    ...
                    <span className={`font-semibold flex items-center gap-1 ${
                      availability.remainingSpots <= 5 ? 'text-amber-600 dark:text-amber-400' : 'text-emerald-600 dark:text-emerald-400'
                    }`}>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 focus:ring-2 focus:ring-emerald-500/50 outline-none transition-all dark:text-white"
                />
            ...
            {tour.addons && tour.addons.length > 0 && (
              <div className="pt-4 border-t border-gray-100 dark:border-gray-800">
                <label className="flex items-center gap-2 text-sm font-semibold text-gray-800 dark:text-gray-200 mb-3">
                  <ShoppingBag className="w-4 h-4 text-emerald-500" /> Optional Add-ons
                </label>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between items-baseline gap-2">
                            ...
                            <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400 shrink-0">+{formatPrice(addon.price)}</span>
                          </div>
                          {addon.description && (
        ...
        <div className={`space-y-6 ${step === 3 ? 'block' : 'hidden'}`}>
          ...
          <div className="bg-gray-50 dark:bg-gray-950 rounded-2xl p-5 border border-gray-150 dark:border-gray-800 space-y-4 text-sm">
            ...
            {!pricingResult.appliedOverride && pricingResult.appliedBracket && (
              <div className="flex items-center gap-1.5 text-xs text-emerald-600 dark:text-emerald-400 bg-emerald-50/50 dark:bg-emerald-950/10 px-3 py-1.5 rounded-lg border border-emerald-200/30">
              ...
              {selectedAddons.length > 0 && (
                <div className="space-y-1.5 pt-1 border-t border-gray-200 dark:border-gray-800">
                  ...
                  {selectedAddons.map((addonId: string) => {
                    ...
                    return (
                      <div key={addonId} className="flex justify-between text-xs pl-2 border-l border-emerald-500 text-gray-650 dark:text-gray-350">
        ...
        {step < 3 && (
          <div className="pt-3 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center text-sm">
            ...
            {!pricingResult.appliedOverride && pricingResult.appliedBracket && (
              <span className="text-[10px] font-semibold text-emerald-700 bg-emerald-50 dark:bg-emerald-950/20 dark:text-emerald-300 border border-emerald-200/50 px-2 py-1 rounded-full">
                👥 Group Discount
              </span>
            )}
          </div>
