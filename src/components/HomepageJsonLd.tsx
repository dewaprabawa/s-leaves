...
const adventureOffers: AdventureOffer[] = [
  ...
  },
  {
    ...
    description:
      "Private 4×4 jeep to the Mount Batur crater rim near Kintamani — no hike, hot drink, hotel pickup. Meals not included; food is not served on the jeep. Solo IDR 1.35M · 3+ from IDR 750K.",
    price: "750000",
    image:
