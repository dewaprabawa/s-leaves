...
const adventureOffers: AdventureOffer[] = [
  ...
  },
  {
    ...
    description:
      "Your private sit-in or tracking 4×4 jeep to Mount Batur near Kintamani — sunrise or sunset, minimum 2 guests, same private rates. Sit-down meal included. Optional hot spring +IDR 150,000 per person with ticket included. Hotel pickup included. 2 pax IDR 950K · 3+ from IDR 750K.",
    price: "750000",
    image:
