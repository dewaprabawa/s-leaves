...
| Included | Not included |
| --- | --- |
| Private shuttle (Ubud-area hotels) | Pickup outside Ubud (ask WhatsApp) |
| English-speaking local guide | Lunch |
...
Covered shoulders. We bring sarong and sash. Do **not** wear the dry temple sarong into the water — use the bathing wrap. Women who are menstruating should not enter the inner courtyards or the pools. Full rules: [Bali temple dress code](/blog/bali-temple-dress-code).

## Shuttle vs other pickup rules

This is **not** the IDR 400,000 ATV/rafting pickup add-on. The Ubud-area shuttle is built into the 1.2M private rate. Cycling and Tumang cooking use complimentary Ubud pickup; the Mount Batur jeep includes island-wide pickup. Policy: [Ubud hotel pickup explained](/blog/ubud-hotel-pickup-bali-adventures-explained).
...
Ready to explore the ancient kingdom? Book your [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) with us today and experience Bali at a village pace.
  ...
  },
  {
    ...
    seoTitle: 'What Is the Subak System? | Pejeng Cycling',
...
Ready to see this living heritage up close? Join us in Pejeng and cycle through the heart of Bali's ancient Subak!
  ...
  },
  {
    ...
    seoTitle: '5 Balinese Spices | Tumang Cooking Class',
...
`
  },
  {
    ...
    seoTitle: 'Bali Temple Dress Code | Melukat Ready',
...
From our Pejeng base we regularly stop at village temples and run private [Tirta Empu / Tirta Empul melukat](/tours/tirta-empu-purification) mornings in Tampaksiring. The pattern is the same every time: covered legs, sash on, quiet voices near the shrine.
...
`
  },
  {
    ...
    seoTitle: 'Top 5 Balinese Foods | Cook Them at Tumang',
...
`
  },
  {
    ...
    seoTitle: 'What Is Base Genep? | Cook It at Tumang',
...
## Tirta Empu Melukat Shuttle

The [Tirta Empu Purification (Melukat)](/tours/tirta-empu-purification) private rate (**IDR 1,200,000 per person**) includes shuttle pickup and drop-off for Ubud-area hotels — not the IDR 400,000 ATV/rafting add-on. Guide: [Tirta Empu melukat near Ubud](/blog/tirta-empu-melukat-ubud-guide).
...
3. The form shows **Within Ubud: Free Pickup** (cycling / Tumang cooking) or the IDR 400,000 hotel pickup charge
...
Operators like ubudcyclingtour.com and multi-day packages on ByFood and Bali Travel Life rank for **cycling cooking class Ubud** because guests want activity *and* culture in one day. Sekar Bali Activity delivers the same intent with Pejeng ricefield cycling plus **[Tumang Bali Cooking Class](https://tumangbaliclass.com/balinese-cooking-class-ubud)** — TripAdvisor Traveler’s Choice 2026.
...
| Include | Details |
| --- | --- |
| Free Ubud hotel pickup & drop-off | Built into the cycling package |
...
### Tumang Bali Cooking Class (afternoon or morning)
...
| Max 8 guests (shared) | Fully hands-on stations |
...
- Food lovers who want a real **cooking class Ubud** with market tour options
- Guests who already booked ATV/rafting and want a slower second day — see also [Pejeng vs Tegallalang](/blog/pejeng-rice-terrace-cycling-vs-tegallalang)
...
`
  },
  {
    ...
    seoTitle: 'Ubud ATV Tracks | Jungle Mud vs Cave',
    excerpt:
...
Why does the price drop per person as the group grows? A private jeep and driver cost the same flat amount whether two or three people ride along, so Sekar Bali Activity splits that fixed cost across the group instead of charging a flat per-seat rate like a shared shuttle would.
...
If you're deciding between the jeep and the traditional Mount Batur sunrise trek, read the full comparison in [Jeep vs sunrise trek](/blog/mount-batur-jeep-vs-sunrise-trek).

## How to Book the Exact Price on WhatsApp

1. Tap **Book Private Jeep** on the [private Mount Batur jeep](/tours/batur-sunrise-jeep-tour) page
2. Send your hotel/area, date, and guest count
3. We confirm the tier rate and exact pickup time — no payment to inquire

**Ready to lock a 2026 price?** Book the [private Mount Batur jeep](/tours/batur-sunrise-jeep-tour) or compare it with our [cooking class](/tours/balinese-cooking-class) and [cycling tour](/tours/ubud-ricefield-cycling-tour) for a multi-day Bali itinerary. Compare routes: [jeep vs sunrise trek](/blog/mount-batur-jeep-vs-sunrise-trek).
`
  },
