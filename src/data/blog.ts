...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      'ATV near Ubud from IDR 600K (single) / 859K (tandem). Lunch, gear, insurance included. Pickup fees and tubing combos explained.',
    publishedAt: '2026-09-03',
    author: 'Sekar Bali Activity',
    image: '/images/adventures/atv-adventure.jpg',
    content: `
**How much does an ATV cost in Bali near Ubud?** With Sekar Bali Activity in 2026, a **Single ATV** starts at **IDR 600,000** (lower tier rates for 2+ and 3+ riders) and a **Tandem ATV** starts at **IDR 859,000** for two people. Packages at **All New Bali Adventure** include lunch, boot shoes, helmet, insurance, and a full safety briefing. Hotel pickup is optional.

> **Key Takeaways**
> - Single ATV: **IDR 600,000** (1 pax) · **IDR 575,000** (2) · **IDR 550,000** (3+)
> - Tandem ATV: **IDR 859,000** for 2 pax sharing one quad
> - Included: lunch, boot shoes, helmet, insurance, English-speaking guide
> - Pickup: **IDR 50,000** one-way or **IDR 100,000** round trip (same hotel); out of Ubud +IDR 50,000 — or self-meet free
> - Optional: **ATV + Wos River tubing** combo after the track
> - Book on WhatsApp — **no upfront payment** to inquire

---

## Bali ATV Price Table (Ubud / Pejeng, 2026)

| Package | Guests | From price (IDR) | What’s included |
| --- | --- | --- | --- |
| Single ATV | 1 | 600,000 | Lunch, gear, insurance, briefing |
| Single ATV | 2 | 575,000 each | Same inclusions · group tier |
| Single ATV | 3+ | 550,000 each | Same inclusions · group tier |
| Tandem ATV | 2 sharing | 859,000 | Same inclusions · one bike for two |
| Optional pickup | — | 50,000 / 100,000 | One-way / round trip to same hotel |
...
## What “From IDR 600K” Actually Buys
...
3. Guided jungle / mud / river-crossing trail ride  
...
When comparing Bali ATV prices, ask:

- Is **lunch** included?  
- Are **boot shoes + helmet** included or rented?  
- Is **insurance** mentioned?  
- Is the arena **All New Bali Adventure** or a different track?  
- Is **hotel pickup** in the base price or IDR 50K–120K extra?  

Sekar Bali Activity lists pickup separately so the trail price stays honest — details in [Ubud hotel pickup explained](/blog/ubud-hotel-pickup-bali-adventures-explained).

## Single vs Tandem: Which Price Fits You?
...
After the track, many guests add **river tubing on the Wos River** for a land-and-water day. Combo planning: [ATV + River Tubing guide](/blog/atv-river-tubing-wos-river-bali).
...
**Ready to lock a 2026 ATV price?** Book the [Bali ATV Adventure](/tours/bali-atv-adventure) or compare all [packages & prices](/#pricing).
`
  },
  {
    ...
    excerpt:
      'Ricefield cycling in Pejeng vs Tegallalang crowds — IDR 475K with free Ubud pickup and lunch. Honest pros, cons, and who should skip it.',
    publishedAt: '2026-09-03',
    author: 'Sekar Bali Activity',
    image: '/images/cycling/rice-field-bikes.jpg',
    content: `
**Is an Ubud cycling tour worth it?** Yes — if you want **quiet rice paddies, village culture, and lunch included**, not another crowded Tegallalang photo stop. Sekar Bali Activity’s **Ubud Ricefield Cycling Tour** is **IDR 475,000** per person with **free Ubud hotel pickup**, lunch, bike, helmet, guide, and insurance through **Pejeng** village paths.

> **Key Takeaways**
> - Worth it for culture travelers, couples, and families who want a gentle full day  
> - **IDR 475,000** · free Ubud pickup · **lunch included** · insurance  
...
| Traveler | Worth it? | Why |
| --- | --- | --- |
| Couples / honeymooners | Yes | Slow pace, village photos, lunch included |
| Families with kids (comfortable on bikes) | Yes | Gentle paths; cultural stops |
| Fitness cyclists seeking climbs | Maybe not | Route is mostly flat / downhill village riding |
...
## What You Actually Get for IDR 475,000
...
Full itinerary: [Ubud Ricefield Cycling Tour guide 2026](/blog/ubud-ricefield-cycling-tour-guide-2026).

## Pejeng vs Tegallalang: Why Location Matters

Many “Ubud cycling” reviews complain about traffic and selfie crowds. Our ride stays in **Pejeng** — historic village east of central Ubud with living Subak terraces. Side-by-side: [Pejeng vs Tegallalang cycling](/blog/pejeng-rice-terrace-cycling-vs-tegallalang).
...
If your Bali day goal is **authentic village time with logistics handled**, an Ubud / Pejeng cycling tour is worth the IDR 475,000 — especially with free pickup and lunch included. If you want mud and motors, spend that day on [ATV at All New Bali Adventure](/blog/how-much-does-atv-cost-bali-ubud-2026) instead.
...
`
  },
  {
    ...
    image: '/images/adventures/atv-adventure.jpg',
    content: `
**What’s the difference between a private ATV near Ubud and a mass-market quad tour?** Private / small-group operators emphasize **clear arena location, inclusions, and WhatsApp confirmation** — not the cheapest anonymous listing. Sekar Bali Activity runs beginner-friendly ATV at **All New Bali Adventure** in Pejeng from **IDR 600,000**, with lunch, gear, and insurance included and **no upfront payment** to inquire.
...
## Side-by-Side: What Guests Notice

| Factor | Mass-market style | Sekar Bali Activity approach |
| --- | --- | --- |
| Booking | Aggregator cart, unclear operator | WhatsApp with name, date, price prefilled |
| Price clarity | “From $XX” with add-ons later | IDR tiers published; pickup listed separately |
| Group feel | Large mixed groups | Private / small-group pacing |
| Arena | Sometimes unspecified | Always **All New Bali Adventure** |
| Inclusions | Variable | Lunch, boot shoes, helmet, insurance |
| Local story | Generic “Bali ATV” | Pejeng-based team + village cycling/culture |

## Why “Private ATV Ubud” Searches Convert

Travelers typing **private ATV Ubud**, **beginner ATV Ubud**, or **Bali quad bike tour Ubud** usually want:

1. A real address / map pin for the arena  
...
Choose a big-group operator if you only want the lowest headline price and don’t mind mixed groups or unclear extras. Choose Sekar Bali if you want **WhatsApp clarity**, Pejeng basing, and optional culture days like [cycling + cooking](/blog/cycling-cooking-class-ubud-full-day-itinerary).

## Next Step

Compare packages on [prices 2026](/blog/bali-adventure-packages-prices-2026), then book [Bali ATV Adventure](/tours/bali-atv-adventure), pair with [ricefield cycling](/tours/ubud-ricefield-cycling-tour), or open [Book](/book) — free to inquire.
`
  },
  {
    slug: 'bali-atv-tour-ubud-guide',
    title: 'Bali ATV Tour Near Ubud (2026)',
    excerpt: 'ATV near Ubud from IDR 600K — trails, lunch, gear, insurance. Optional Wos tubing. WhatsApp booking, no upfront payment.',
    publishedAt: '2026-08-30',
    author: 'Sekar Bali Activity',
    image: '/images/adventures/atv-adventure.jpg',
    content: `
**What is the best way to book a Bali ATV tour near Ubud?** Book a beginner-friendly Single or Tandem ATV ride at **All New Bali Adventure** in Pejeng with gear, lunch, and insurance included. Sekar Bali Activity offers Single ATV from **IDR 600,000** (group tiers lower) and Tandem ATV from **IDR 859,000**, with optional **Wos River tubing** after the track.

> **Key Takeaways**
> - Single ATV from IDR 600,000 (1 pax); tier rates for 2+ / 3+; Tandem from IDR 859,000 (2 pax)
> - Included: guided ATV ride, boot shoes, helmet, lunch, insurance, safety briefing
> - Hotel pickup optional (IDR 50,000 one-way / IDR 100,000 round trip) or self-meet at All New Bali Adventure
...
> - Book via WhatsApp — no upfront payment to inquire

---

## 2026 ATV Price Table (Ubud / Pejeng)

| Package | Guests | From price (IDR) | Notes |
| --- | --- | --- | --- |
| Single ATV | 1 | 600,000 | Own quad · lunch + gear + insurance |
| Single ATV | 2 | 575,000 each | Same inclusions · group tier |
| Single ATV | 3+ | 550,000 each | Same inclusions · group tier |
| Tandem ATV | 2 sharing | 859,000 | One bike for two · same inclusions |
| ATV + Wos tubing | ask | combo quote | Trail first, then river float |

Prices match our live [Bali ATV Adventure](/tours/bali-atv-adventure) page. Confirm the day’s rate on WhatsApp before you ride.
...
| Safety briefing & guide | English-speaking — beginner-friendly |
| Optional hotel pickup | IDR 50,000 each way to the same Ubud-area hotel |

**Not included:** personal expenses, gratuities, out-of-area pickup surcharges, and tubing unless you choose the combo.

## What To Bring

1. **Changing clothes or a dry cloth** — trails get muddy  
2. **Sunscreen** — for open trail sections  
3. **Cash for extras** — snacks, souvenirs, or tips  
4. **Waterproof phone case** (optional) — handy for trail photos  

Towels and changing facilities are available at the base.
...
Couples, friends, and first-timers staying in/near Ubud. Children can join when age-appropriate — tell us ages when you message so we assign Adult or Child correctly.
...
- Start checkout: [Book](/book)
- Popular trips: [ATV](/tours/bali-atv-adventure) · [Cycling](/tours/ubud-ricefield-cycling-tour) · [Cooking class](/tours/balinese-cooking-class)
`
  },
  {
...
If you join our [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour), you aren't just riding through random rice paddies—you are cycling through the remnants of a kingdom.
...
Ready to explore the ancient kingdom? Book your [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) with us today and experience Bali at a village pace.
    `
  },
  {
...
When you join our [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour), you will cycle directly through these ancient waterways, and our local guides will show you exactly how this incredible system functions.
...
Reading about these spices is one thing, but smelling them as you pound them together in a stone mortar is an experience you won't forget. In our [Balinese Cooking Class](/tours/balinese-cooking-class), our local chefs will guide you through the creation of 5 authentic dishes, all starting with these incredible raw ingredients. Prefer a full culture day? Pair it with the [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) or [book both](/book) on WhatsApp.
    `
  },
  {
    slug: 'luwak-coffee-ethical-sourcing',
    title: "Ethical Luwak Coffee in Pejeng",
    excerpt: "Cage-free vs commercial Luwak in Bali — how Umah Kuno wild-harvests beans in Pejeng and which red flags to avoid.",
...
## Visit Umah Kuno on a Pejeng day

Pair an ethical tasting with village adventures we run from Pejeng:

- [Luwak Coffee Plantation](/tours/luwak-coffee-plantation) — cage-free tasting walkthrough
- [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) — Subak lanes + lunch
- [Balinese Cooking Class](/tours/balinese-cooking-class) — Base Genep dinner class
- Or [book on WhatsApp](/book) with your hotel and preferred date
    `
  },
  {
...
For example, instead of renting a bicycle on a crowded main road, you can join our [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour). We ride through the quiet, ancient village of Pejeng, navigating secret paths through the Subak rice terraces where you won't see another tourist all morning. 
...
* **Local Life is Active:** Traditional markets, like the one we visit on our [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour), only operate in the early morning. It is the best time to see the island waking up.
...
* [Traditional Cooking Classes](/#adventures) (Ending with dinner!)
* [Luwak Coffee Tastings](/#adventures) (A great afternoon pick-me-up)
* Spa treatments
* Beach walks
...
No matter when you decide to explore, our family is ready to welcome you. Check out our [Full List of Experiences](/#adventures) to find the perfect addition to your Bali itinerary.
`
  },
  {
...
*(Want us to handle the driving? Book our [Full Day Ubud Tour: Royal Palace, Art Market & Rice Terraces](/#adventures) today!)*
...
*(Short on time? We offer a dedicated [Half Day Trip: Explore Ubud Culture & Amazing Sunset at Tanah Lot Temple](/#adventures) that perfectly times this experience for you!)*
`
  },
  {
...
`
  },
  {
    ...
    excerpt: "Sarong, sash, covered shoulders — what temples require in Bali, plus what we provide on tours. Avoid gate turnaways.",
    publishedAt: "2026-08-05",
    author: "Sekar Bali Activity Team",
    image: "https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&w=1200&q=80",
    content: `
**What is the dress code for temples in Bali?** Both men and women must cover legs below the knee with a *kamen* (sarong) and tie a *selendang* (sash) at the waist. Shoulders and upper arms must be covered — no tank tops, sleeveless shirts, or beachwear. When you visit temples with Sekar Bali Activity (for example on a [Half Day Tanah Lot sunset stop](/#adventures)), we bring clean sarongs and sashes so you are not pushed into buying tourist-mark-up fabric at the gate.

> **Quick checklist before you enter**
> - Sarong covering knees to ankles  
> - Sash tied at the waist  
> - Sleeved top covering shoulders  
> - Remove hat inside the inner courtyard when asked  
> - Do not enter the jeroan (innermost courtyard) during menstruation — this is a living religious rule, not a tourist suggestion  

---

### Why temples enforce dress codes

Balinese Hindu temples are active prayer spaces, not outdoor museums. Families from Pejeng, Ubud, and Gianyar bring daily offerings; priests (*pemangku*) lead ceremonies on the 210-day Pawukon calendar. Clothing signals respect for *suci* (ritual purity). Locals notice guests who arrive in beachwear — and gate staff will turn you away or rent you a sarong at a premium.

From our Pejeng base we regularly stop at village temples and water temples near Tirta Empul / Tampaksiring routes. The pattern is the same every time: covered legs, sash on, quiet voices near the shrine.

### The three pieces that matter

**1. Sarong (*kamen*)**  
Wrap fabric so it falls to the ankles. Men and women both wear one. A beach sarong is fine if it is opaque and long enough; sheer cover-ups are not.

**2. Sash (*selendang*)**  
Tied over the sarong at the waist. It marks the boundary between the “upper” and “lower” body in temple symbolism. Staff at major sites will help you tie it if you ask.

**3. Upper body**  
T-shirt or shirt with sleeves. Avoid deep necklines. Sport bras alone or crop tops will not pass.

**Shoes:** You usually keep sandals on in outer courtyards; follow the local lead if a pavilion asks you to remove them.

### What we see guests get wrong

1. **Wearing the sash like a scarf around the neck** — it belongs at the waist.  
2. **Rolling the sarong above the knee** for photos — gate attendants will stop you.  
3. **Assuming “tourist temple” rules are softer** — Tanah Lot, Uluwatu, and Tirta Empul still enforce coverage.  
4. **Buying the first sarong at the parking lot** — prices are higher than Ubud market stalls; borrow ours on a guided stop when you can.

### Renting vs bringing your own

Tanah Lot, Tirta Empul, and Uluwatu offer rental or loan sarongs at the entrance. Quality varies and queues build mid-morning. If you travel with a private driver on our [Full Day Ubud Tour](/#adventures), we pack clean sarongs and sashes in the car so you move straight from village roads to the courtyard without a retail stop.

For independent visits, a simple cotton sarong from an Ubud stall (often under IDR 50,000) pays for itself after two temples.

### Temple etiquette beyond clothing

- Walk clockwise around shrines unless a priest directs otherwise.  
- Do not stand higher than the priest or climb on *meru* roofs for photos.  
- Point with your thumb or open hand, not a single finger, when asking directions.  
- If a ceremony is underway, wait at the outer wall until invited closer.  
- Drones are usually banned inside temple compounds — ask first.

These habits matter as much as the sarong when you cycle past village temples on rice-paddy lanes in Pejeng.

### After temples: a Pejeng day that fits the same respect
...
### A note from Pejeng guides

Guests who stay east of Ubud often combine Tirta Empul or a village temple with the same day’s cycling. We keep spare sashes in the cycling van because Subak lanes pass shrines where a short prayer stop is normal — you should already be covered before you roll past. If you are only doing ATV mud tracks that day, temple clothes still matter for any side stop your driver suggests.

For families: children wear the same sarong/sash rules at major temples. Ask us for a child-length sash when you WhatsApp your ages.

Bring a light long-sleeve layer for early temple visits — stone courtyards stay cool before 9am, then heat builds fast. We would rather you over-cover and roll sleeves later than argue with gate staff over bare shoulders. Keep water and a small towel in your bag — Tirta Empul courtyards get wet, and Pejeng village paths get dusty by late morning.

### Book with clear questions

Message WhatsApp with your temple stop (if any), preferred adventure, and hotel area. We confirm sarong provision, pickup rules, and IDR pricing in one thread — no surprise “dress rental” add-ons at the gate.
`
  },
  {
...
`
  },
  {
    ...
    excerpt: "Quiet Pejeng Subak lanes vs busy Tegallalang photo terraces — which Ubud rice-field day fits you. Lunch + free Ubud pickup on our ride.",
...
- **Ubud Ricefield Cycling Tour**: Paved, gently sloping village lanes and dirt ridge paths suitable for families, couples, and seniors. Our [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) includes comfortable mountain bikes, helmets, and a dedicated local guide.
...
`
  },
  {
    ...
    title: "What Is Base Genep Spice Paste?",
    excerpt: "Base Genep explained — 15-spice Balinese paste, why hand-pounding matters, and where to cook it in Pejeng.",
...
- [Bali ATV Adventure](/tours/bali-atv-adventure) at All New Bali Adventure (from IDR 600K)
- [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) with free Ubud hotel pickup (IDR 475K)
...
When joining our [Balinese Cooking Class](/#adventures) or visiting a local Pejeng family compound, always take off your sandals or shoes at the entrance of the sleeping and kitchen pavilions. 
...
When cycling on narrow village trails during our [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour), dismount your bicycle if passing through an active temple ceremony or village procession (*Melasti*). Ringing bike bells or rushing through a religious gathering is considered disrespectful.

***

**Want to experience authentic village life with local hosts?** Explore Pejeng with born-and-raised local guides on our [Full Day & Half Day Experiences](/#adventures).
`
  },
  {
    slug: "how-to-spot-ethical-luwak-coffee-in-bali",
    title: "Spot Ethical Luwak Coffee in Bali",
    excerpt: "Cage-free vs commercial Luwak farms near Ubud — wild harvest signs, tasting tips at Umah Kuno, and how to book a Pejeng visit.",
...
> - **Ethical Visit**: Book our [Luwak Coffee Plantation Experience](/#adventures) at Umah Kuno.
...
Book the [Luwak Coffee Plantation](/tours/luwak-coffee-plantation) tasting, or build a Pejeng day with [ricefield cycling](/tours/ubud-ricefield-cycling-tour) and a [Balinese cooking class](/tours/balinese-cooking-class). Start on [Book](/book) if you already know your date.
`
  },
  {
    slug: 'ubud-ricefield-cycling-tour-guide-2026',
    title: 'Ubud Ricefield Cycling Tour: Full Itinerary, Price & What Is Included (2026)',
    excerpt: 'Everything you need to book the Ubud Ricefield Cycling Tour — IDR 475,000 per person, free Ubud pickup, lunch included, and an 8-step village itinerary through Pejeng rice terraces.',
    publishedAt: '2026-09-01',
    author: 'Sekar Bali Activity',
    image: '/images/adventures/cycling.jpg',
    content: `
**How much does the Ubud Ricefield Cycling Tour cost?** Sekar Bali Activity offers the full-day Ubud Ricefield Cycling Tour for **IDR 475,000 per person**, including **free hotel pickup within Ubud**, lunch, plus a guided ride through Pejeng rice terraces and village life.

> **Key Takeaways**
> - **IDR 475,000** per person — the only tour with free Ubud pickup
...
> - Book via WhatsApp or tap **Details** in the booking popup to preview the full itinerary

---

## Why Choose the Ubud Ricefield Cycling Tour?
...
3. **Sightseeing & harvesting activity** — seasonal hands-on experience
4. **Visit a Balinese house** — see traditional compound life
...
| Village experiences | House visit, carving, harvesting (seasonal) |

## Who Is This Tour For?

Families with children, couples wanting a slower Bali day, and anyone who prefers culture over adrenaline. If you want mud and motors instead, see our [Bali ATV Adventure at All New Bali Adventure](/tours/bali-atv-adventure) or combine land and water with [ATV + Wos River tubing](/blog/atv-river-tubing-wos-river-bali).
...
**Ready to ride?** [Book the Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) — from IDR 475,000 with lunch and free Ubud pickup.
`
  },
  {
    slug: 'bali-whitewater-rafting-near-ubud-guide',
    title: 'Whitewater Rafting Near Ubud: Rapids, Prices & Booking Guide (2026)',
    excerpt: 'Plan a Bali whitewater rafting day near Ubud — Class II–III rapids, IDR 400,000 per person, safety gear included, and how to combine rafting with ATV or cycling.',
    publishedAt: '2026-09-01',
    author: 'Sekar Bali Activity',
    image: '/images/adventures/rafting.jpg',
    content: `
**How much does whitewater rafting near Ubud cost?** Sekar Bali Activity offers whitewater rafting from **IDR 400,000 per person**, including safety equipment, professional guides, and a post-ride lunch. Pickup from Ubud and nearby areas is available (surcharge applies outside the free cycling pickup zone).

> **Key Takeaways**
> - **IDR 400,000** per person on Class II–III rapids
...
> - Use the booking popup **Details** button to preview the rafting itinerary before you confirm

---

## What to Expect on the River

After hotel pickup and a safety briefing, you paddle through jungle-lined rapids with an experienced guide. The route balances splashy sections with calmer stretches so first-timers can enjoy the ride without extreme whitewater.
...
| Include | Details |
| --- | --- |
| Professional river guide | English-speaking, safety-focused |
| Helmet & life jacket | Fitted before launch |
| Lunch | Served after the river section |
| Insurance | Covered on the package |

## Build a Full Adventure Day

Many guests book rafting as one half of a bigger Bali adventure:

- **Land + water:** [Bali ATV at All New Bali Adventure](/tours/bali-atv-adventure) in the morning, rafting in the afternoon
- **Gentle float alternative:** [Canyon tubing](/tours/canyon-tubing) on the Wos River — lower intensity than rafting
- **Culture day:** [Ubud Ricefield Cycling Tour](/tours/ubud-ricefield-cycling-tour) with free Ubud pickup and lunch included

Compare all options in our [Bali adventure packages & prices guide](/blog/bali-adventure-packages-prices-2026).
...
**Book rafting near Ubud** — [Whitewater Rafting Adventure from IDR 400,000](/tours/whitewater-rafting).
`
  },
  {
...
> - Preview the itinerary in the booking popup via **Details**

---

## Canyon Tubing vs Whitewater Rafting

| | Canyon Tubing | Whitewater Rafting |
| --- | --- | --- |
| **Intensity** | Gentle float, canyon scenery | Class II–III rapids, more splash |
| **Price** | From IDR 359,000 | From IDR 400,000 |
...
The classic land-and-water day: race quad bikes through jungle mud at **All New Bali Adventure**, then cool off on the Wos River. Read the full combo guide: [ATV + River Tubing on the Wos River](/blog/atv-river-tubing-wos-river-bali).

## What to Bring

- Changing clothes or dry outfit
...
`
  },
  {
    ...
    excerpt: 'Compare Sekar Bali Activity adventure prices in one place — ATV from IDR 600K, rafting IDR 400K, canyon tubing IDR 359K, and Ubud ricefield cycling IDR 475K with free pickup and lunch.',
    publishedAt: '2026-09-01',
    author: 'Sekar Bali Activity',
    image: '/images/adventures/hero-banner.jpg',
    content: `
**What do Bali adventure tours cost near Ubud in 2026?** Sekar Bali Activity publishes transparent IDR pricing: **Single ATV from IDR 600,000**, **Tandem ATV from IDR 859,000**, **Whitewater Rafting IDR 400,000**, **Canyon Tubing IDR 359,000**, and **Ubud Ricefield Cycling Tour IDR 475,000** with free Ubud pickup and lunch included.

> **Key Takeaways**
> - All prices in Indonesian Rupiah (IDR) — no hidden booking fees to inquire
> - **Free Ubud pickup** applies to the cycling tour only; other activities add IDR 120,000 outside Ubud
...
| Ubud Ricefield Cycling | IDR 475,000 | person | [Cycling Tour](/tours/ubud-ricefield-cycling-tour) |

## Pickup Policy

- **Ubud Ricefield Cycling Tour:** Free pickup and drop-off within Ubud
- **ATV, rafting, tubing:** Pickup available; **IDR 120,000 surcharge** applies for locations outside Ubud
...
Most adventures include hotel transfer (see pickup policy), safety gear, English-speaking guide, and lunch. The cycling tour includes **lunch** plus free Ubud pickup. Confirm inclusions on each tour page or via the booking **Details** button.

## How to Book (Fastest Path)

1. Open [sekarbaliactivity.com](/)
2. Tap **Book Now** on your chosen activity
3. Tap **Details** in the popup to read the full itinerary
4. Fill the form and send to WhatsApp — or read [How to Book on WhatsApp](/blog/how-to-book-bali-adventure-whatsapp)
...
`
  },
  {
    ...
    image: '/images/adventures/cycling.jpg',
    content: `
**Which Bali adventure tour includes free Ubud hotel pickup?** Only the **Ubud Ricefield Cycling Tour** (IDR 475,000) includes free hotel pickup and drop-off within Ubud. ATV, whitewater rafting, and canyon tubing do not include free pickup — IDR 120,000 surcharge applies for locations outside Ubud.
...
The cycling tour is a full-day village experience starting from Pejeng. Pickup within Ubud is built into the IDR 475,000 price along with lunch. See the [cycling tour guide](/blog/ubud-ricefield-cycling-tour-guide-2026).
...
`
  },
  {
    ...
    image: '/images/adventures/hero-banner.jpg',
    content: `
**What is the best adventure near Ubud — ATV, rafting, or tubing?** It depends on your style: **ATV** (from IDR 600,000) for jungle mud and quad bikes at All New Bali Adventure; **rafting** (IDR 400,000) for Class II–III rapids; **canyon tubing** (IDR 359,000) for a gentle Wos River float. Sekar Bali Activity offers all three with WhatsApp booking.
...
> - **Best value + free pickup:** Ubud Ricefield Cycling (IDR 475,000, lunch included, free Ubud pickup)
...
| --- | --- | --- | --- | --- |
| **Price** | IDR 600K+ | IDR 400K | IDR 359K | IDR 475K |
...
`
  },
  {
    ...
    title: 'Cycling + Cooking Class Day in Ubud',
    excerpt:
      'Pejeng ricefield cycling (IDR 475K) plus evening cooking class (IDR 400K) — full-day timeline, inclusions, and WhatsApp booking.',
    publishedAt: '2026-09-03',
    author: 'Sekar Bali Activity',
    image: '/images/cycling/rice-field-bikes.jpg',
    content: `
**What is the best cycling and cooking class combo in Ubud?** Pair Sekar Bali Activity’s **Ubud Ricefield Cycling Tour** (IDR 475,000 — free Ubud hotel pickup, lunch included) with a **Traditional Balinese Dinner Cooking Class** (IDR 400,000 — 5 dishes, Base Genep, recipe book) for a full cultural day in Pejeng near Ubud.

> **Key Takeaways**
> - Competitor-style combo day: **rice paddy cycling** first, **hands-on Balinese cooking class** in the evening
> - Cycling: **IDR 475,000** / person · free Ubud pickup · bike, helmet, guide, lunch, insurance
> - Cooking class: **IDR 400,000** / person · 17:30–20:30 · cook 5 authentic dishes at your own station
...
## Why Travelers Search “Cycling & Cooking Class Ubud”

Operators like ubudcyclingtour.com and multi-day packages on ByFood and Bali Travel Life rank for **cycling cooking class Ubud** because guests want activity *and* culture in one day. Sekar Bali Activity delivers the same intent with two bookable experiences based in **Pejeng** — quieter Subak rice terraces by day, open-air kitchen by night — instead of mass-market tourist routes.
...
| Afternoon | Continue village life sights; lunch included on the cycling package | Cycling |
| Hotel return | Drop-off at your Ubud hotel to rest and freshen up | Cycling |
| 17:30–20:30 | Hands-on dinner cooking class: Base Genep, Sate Lilit, Lawar, Sambal Matah, Dadar Gulung | [Balinese Cooking Class](/tours/balinese-cooking-class) |

Ask WhatsApp if you prefer a lighter cycling half-day before the dinner class — we can adjust timing around your hotel location.
...
| Include | Details |
| --- | --- |
| Free Ubud hotel pickup & drop-off | Only on the cycling tour |
| Bicycle, helmet & English-speaking guide | All fitness levels — mostly flat village paths |
| Lunch | One meal at a village restaurant |
| Cultural stops | Harvesting (seasonal), family house, carving studio |
| Insurance | Included |

### Balinese cooking class (evening)

| Include | Details |
| --- | --- |
| All ingredients & cooking station | Mortar (*ulekan*), wok, utensils |
| English-speaking culinary instructor | Spice intro + hands-on coaching |
| 5 dishes you cook yourself | Then eat family-style |
| Digital recipe book | Take home |

Cooking-class transport is **not** included — most Ubud hotels are a short ride from the Pejeng kitchen after your cycling drop-off. Message us if you need help arranging the evening transfer.

## Prices 2026 (Transparent IDR)

| Experience | From price | Notes |
| --- | --- | --- |
| Ubud Ricefield Cycling Tour | **IDR 475,000** / person | Tier rates for 2+ and 3+ groups |
| Traditional Balinese Dinner Cooking Class | **IDR 400,000** / person | Child rate available |
...
- Couples and small groups who want **culture over adrenaline**
- Travelers comparing **Pejeng village cycling** vs Tegallalang crowds
- Food lovers who want a real **Balinese cooking class Ubud** (not a demo-only kitchen)
- Guests who already booked ATV/rafting and want a slower second day — see also [Pejeng vs Tegallalang](/blog/pejeng-rice-terrace-cycling-vs-tegallalang) and [Inside our cooking class](/blog/inside-balinese-cooking-class-pejeng)

Prefer mud and motors instead? Start with [Bali ATV for Ubud](/blog/bali-atv-tour-ubud-guide) or the [ATV + Wos River tubing combo](/blog/atv-river-tubing-wos-river-bali).

## How to Book the Combo on WhatsApp

1. Tap **Book** on [sekarbaliactivity.com](/) or message +62 817 7572 3663  
2. Send: **name, ages, adult/child counts, hotel, date, “cycling + cooking class”**  
3. We confirm timing for ricefield cycling pickup and the 17:30 dinner class  
4. No upfront payment is required to inquire  

Full cycling details: [Ubud Ricefield Cycling Tour guide](/blog/ubud-ricefield-cycling-tour-guide-2026). Full kitchen walkthrough: [Inside our Pejeng cooking class](/blog/inside-balinese-cooking-class-pejeng).

**Ready for a full cultural day?** Book [ricefield cycling](/tours/ubud-ricefield-cycling-tour) and the [Balinese cooking class](/tours/balinese-cooking-class) together via WhatsApp.
`
  },
]
