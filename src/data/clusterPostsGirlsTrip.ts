/** Private itinerary cluster — family, girls trip, friends, couple, long driver days. */

export const GIRLS_TRIP_CLUSTER_POSTS = [
  {
    slug: 'bali-6-day-girls-trip-itinerary-2026',
    title: '6-Day Bali Girls Trip Itinerary 2026: Photo Days, Clubs, and What We Book',
    seoTitle: '6-Day Bali Girls Trip Itinerary | Driver + Swing',
    excerpt:
...
> **Key Takeaways**
> - We handle **driver days** (car from **IDR 600,000** / day) and a **HiAce quote** for 6+
> - Day 2 money product: **[Swing Heaven + koi boat](/tours/swing-heaven-bali)** — not Tegallalang
> - Day 5 money product: **[private Batur jeep](/tours/batur-sunrise-jeep-tour)** — crater rim, not the summit hike
> - Clubs, dinner venues, Kecak seats, spa, jewelry, and boats stay **your bookings**
> - Skip **Nusa Penida**, **Lovina dolphins**, extra temples, and mall days on a 6-day clock
> - WhatsApp a **consultation** (no booking form): **[private itinerary page](/tours/bali-private-itinerary)** — no payment to inquire

## What is a Bali girls trip we can actually run?

A **Bali girls trip** in this niche is a **4–7 day friend-group itinerary** with a **private driver**, one **big photo day**, one **sunrise / volcano morning**, and nights that stay social. It is not a 12-stop island tour. Six people need time for outfits, group photos, and meals — the plan should leave slack.

Sekar Bali Activity is a **Ubud-area activity operator**, not a beach-club concierge. We sell the days that have a published IDR on this site. We do **not** sell FINNS, La Favela, Savaya, Cretya, Taman Dedari, silver workshops, spa beds, or Tanjung Benoa boats. Our driver can still move you between those pins.

## 6-day sample (Seminyak villa + Ubud days)

This maps the common **2026 ladies plan**: south-Bali villa, two Ubud days, one Uluwatu night, one Kintamani sunrise, one water morning, then airport.

| Day | Vibe | We book | You book |
| --- | --- | --- | --- |
...
### Day 1 — Seminyak, FINNS, La Favela

Villa breakfast, Seminyak Village coffee, a short beach photo, then **FINNS** as the main afternoon. Night: **La Favela**. We do not hold those tables. If you want one WhatsApp thread for the **car**, send villa area and the first pickup time. Six guests usually need a **HiAce / 10–12 seater**, not a 4-seat car.

Do not stay out so late that Day 2’s **07:00 Ubud departure** collapses. Swing Heaven opens **08:00–17:00**; a 6-person photo set needs **3+ unhurried hours**.

### Day 2 — Swing Heaven is the photo day (priority)

**09:00–12:30** at **[Swing Heaven, Jl. Tangga Yuda, Bongkasa](/blog/swing-heaven-bongkasa-location)** over the **Ayung River**. Book the **swing + koi boat** on our ticket. **Photographer is not included** — shoot on your phones, or hire a freelancer yourself. Flying dress hire is **IDR 300,000** extra.
...
Melasti beach photos, ocean-view lunch, **Uluwatu Temple** (shoulders and knees covered; sarong on), **Kecak fire dance** at sunset, then **Savaya** as a **night** stop — not a sunset-club substitute for Kecak. We supply the **driver**. You buy temple and dance tickets.

### Day 4 — Soft Ubud: culture you can feel

Kanto Lampo (or skip if Day 2 ran long). A **silver jewelry class** is a guest booking — we do not sell it. If you want a cultural activity **we actually operate**, swap in **[Tumang cooking class](/tours/balinese-cooking-class)** (shared promo **IDR 450,000**, free Ubud pickup, max 8). For a waterfall ritual instead of a third temple, book **[Griya Beji in Punggul](/tours/griya-beji-waterfall)** — not Tirta Empul.

Spa and **Taman Dedari** dinner stay yours. Outfit: floral / long dress for statue photos.
...
**Besakih** is a guest temple ticket. Many 6-day plans skip a second temple after Uluwatu — that matches our [what to skip](/blog/what-to-skip-on-a-6-day-bali-itinerary) list. Evening: **villa home party**, not another club.

### Day 6 — Water morning, light shopping, airport

Tanjung Benoa **flying fish / parasailing** is yours. If the group wants a sport we price in IDR, swap to **[ATV](/tours/bali-atv-adventure)** or **[Ayung rafting](/tours/whitewater-rafting)** (pickup **IDR 400,000** or self-meet). Keep shopping small. Farewell dinner at the villa. We can run the **[DPS transfer](/transfers)** from **IDR 700,000** per standard MPV — HiAce airport quote on WhatsApp.

## How to send this plan in one message

1. Open **[private Bali itinerary](/tours/bali-private-itinerary)** and tap **WhatsApp Consultation** (no booking form)
2. Send **group type = girls trip**, dates, villa area, guest count, car vs HiAce
3. Paste the day list
...
`,
  ...
  {
    slug: 'bali-family-private-itinerary-2026',
    title: 'Bali Family Private Itinerary 2026: Slow Days, Jeep, Cooking, Driver',
    seoTitle: 'Bali Family Private Itinerary | Driver + Jeep',
    excerpt:
      'A private family Bali week: no-hike Batur jeep, Tumang cooking, Pejeng cycling, one swing stop. We book the driver and those SKUs. Restaurants and spa stay yours.',
    publishedAt: '2026-09-23',
    author: 'Sekar Bali Activity',
    image: '/images/adventures/cycling.jpg',
    content: `
**Can a local operator run a private Bali family itinerary without a party-bus pace?** Yes. **[Sekar Bali Activity](/tours/bali-private-itinerary)** books the **private driver**, the **[no-hike Mount Batur jeep](/tours/batur-sunrise-jeep-tour)**, **[Tumang cooking class](/tours/balinese-cooking-class)**, and **[Pejeng cycling](/tours/ubud-ricefield-cycling-tour)**. Kids get slack. You keep restaurant tables and spa. The same desk quotes **[girls trips](/blog/bali-6-day-girls-trip-itinerary-2026)** and one long private day.
...
> - WhatsApp a **consultation** (no booking form): **[private itinerary](/tours/bali-private-itinerary)** — no payment to inquire

## What a family week actually needs
...
`,
  ...
  {
    slug: 'bali-private-itinerary-what-we-book-vs-you-book',
    title: 'Private Bali Itinerary: What We Book vs What You Keep',
    seoTitle: 'Private Bali Itinerary Split | Driver + Days',
    excerpt:
...
Clubs and dinner venues take **name + card + guest list** on their own systems. If we pretended to “include FINNS,” we would be inventing inventory. Families get the same honesty: we do not resell a spa we do not operate.

What we **do** control is published on this domain: **IDR**, pickup rules, and WhatsApp confirmation. That is the easy part of a long trip or a 10–14 hour private day.

## We book (published IDR)

| Item | 2026 from-price | Notes |
| --- | --- | --- |
...
- **FINNS**, other beach clubs, **La Favela**, **Savaya**
- **Cretya**, Alas Harum, **Taman Dedari**
- **Uluwatu** entrance + **Kecak** seats
- Silver jewelry workshop, spa / massage beds
- Tanjung Benoa flying fish / parasailing / flyboard
- Villa meals, kids’ rest blocks, night-club guest lists

Tell the driver the **pin and the wait / come-back time**. We do not need those confirmation emails.
...
Send **group type, dates, villa area, headcount (kids’ ages if family), vehicle, and the day list**. We return:

1. Driver-day count × car or HiAce rate (or one long-day block)
...
`,
  ...
  {
    slug: 'what-to-skip-on-a-6-day-bali-itinerary',
    title: 'What to Skip on a 6-Day Private Bali Itinerary (2026)',
    seoTitle: 'What to Skip on a 6-Day Bali Itinerary',
    excerpt:
      'On a 6-day private Bali week — family or girls trip — skip Nusa Penida, Lovina dolphins, extra temples, mall days, and three Kintamani cafés. Keep one sunrise and slack.',
    publishedAt: '2026-09-23',
    author: 'Sekar Bali Activity',
    image: '/images/adventures/full-day-ubud-tour.jpg',
    content: `
...
Six people — kids or adults — already need meals, toilets, and photos. A boat to Penida or a 3-hour drive to Lovina **before sunrise** turns the week into transit. The useful goal is **one memory a day**, not a Bali bingo card.

## Skip list (and what to do instead)
...
| **3–4 cafés in one day** | Same latte, more traffic | One viewpoint **or** the jeep rim — not both plus two more |
| **Shopping malls for hours** | Not why most groups flew | One hour for gifts on the last day |

## Priority when the day slips

1. The **booked activity** (swing, cooking, jeep)
2. **Kids’ rest** on a family week; **group photos** on a girls trip
3. Cut **hot spring**, **second waterfall**, **second temple**

## Honest “we don’t sell that” list
