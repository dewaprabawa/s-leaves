/** Griya Beji Waterfall cluster — purification, palm reading, mental healing. */

export const GRIYA_BEJI_CLUSTER_POSTS = [
  {
...
| Offering | Price (IDR) | What it is |
| --- | --- | --- |
| Waterfall purification (melukat) | **300,000** | Offerings, prayer, spring-fed pool |
| Palm reading | **1,000,000** | Hands + birth date · book ahead |
| Mental healing therapy | **1,500,000** | Guided relaxation / hypnotherapy · book ahead |
| International admission | **50,000** | Gate ticket (domestic **20,000**) |
| Hotel pickup | **400,000** | Optional · self-meet free |

These are the **2026 published park prices**. We confirm the live board on WhatsApp before you transfer.

## Griya Beji vs Tirta Empul vs Pura Beji

| | Griya Beji Waterfall | Tirta Empul / Pura Beji (our other ticket) |
| --- | --- | --- |
| Where | **Punggul, Abiansemal** | Tampaksiring (Empul) or a quieter holy spring |
| Setting | Waterfall + spring pool | Temple fountains |
| From (IDR) | **300,000** ritual | **1,200,000** private |
...
Sarong and sash — swimwear is not the ritual dress. Women who are menstruating should not enter the inner grounds or the purification pool. The site is a living shrine, not a swimming hole. Arrive calm; keep voices low.

## How to book

1. Open [Griya Beji Waterfall](/tours/griya-beji-waterfall)
...
`,
  ...
  {
    slug: 'griya-beji-vs-tirta-empul-melukat',
    title: 'Griya Beji vs Tirta Empul Melukat: Which Purification to Book',
...
| | Griya Beji Waterfall | Tirta Empul or Pura Beji |
| --- | --- | --- |
| Address | Jl. Mawar, **Desa Punggul**, Abiansemal | Tampaksiring (Empul) or quieter Beji spring |
| Ritual price | **IDR 300,000** | **IDR 1,200,000** private |
| Gate ticket | **50,000** intl / **20,000** domestic | Included in the private rate |
| Shuttle | Optional **IDR 400,000** | **Included** (Ubud area) |
| Breakfast | No | **Yes** |
| Extra therapies | Palm **1M** · healing **1.5M** | No |
| Hours | 09:00–18:00 | Typical 08:00 / 09:00 start |

## When to pick Griya Beji

- You want the **waterfall** setting, not the famous Empul queue
- You may add **palm reading** or **mental healing** the same visit
- You are already in Abiansemal (ATV / Swing Heaven) and can self-meet

## When to pick Tirta Empul / Pura Beji

- You want a **guide who walks the fountains** and a **hotel shuttle**
- Breakfast after the pools matters
- You specifically want **Pura Tirta Empul** in Tampaksiring
...
`,
  ...
  {
    slug: 'palm-reading-bali-griya-beji',
    title: 'Palm Reading in Bali at Griya Beji Waterfall: Price & What to Expect',
    ...
    content: `
**How much is palm reading at Griya Beji Bali?** Sekar Bali Activity books palm reading at **[Taman Beji Griya Waterfall](/tours/griya-beji-waterfall)** for **IDR 1,000,000** per person. The reader combines **hand lines with your birth date** — character, elements, livelihood, and relationships. **Book ahead**; walk-in slots are limited. Gate admission (**IDR 50,000** international) is extra. Pickup **IDR 400,000** or self-meet in **Punggul**.

> **Key Takeaways**
> - **IDR 1,000,000** per person · confirm the 2026 board
> - Birth date + palms — not a stage magic show
> - Same park as waterfall **purification IDR 300,000** and **mental healing IDR 1,500,000**
> - Not a medical or legal advice session
> - WhatsApp **date + guest count** — no deposit to ask

## What the session is

The park describes palm reading as a look at character, elements, auspicious days, food notes, livelihood, and relationships. Bring your **date of birth**. A session is typically under 90 minutes. It is **optional** — you can book purification without it.
...
1. Open [Griya Beji Waterfall](/tours/griya-beji-waterfall)
2. WhatsApp **palm reading, date, name, birth date, hotel**
3. We confirm the IDR total — **no payment to inquire**

**Ready?** Book [Griya Beji](/tours/griya-beji-waterfall) or read [mental healing](/blog/mental-healing-bali-griya-beji).
`,
  },
  {
    slug: 'mental-healing-bali-griya-beji',
    title: 'Mental Healing in Bali at Griya Beji: Therapy Price 2026',
    ...
    image: '/images/adventures/griya-beji-ceremony.jpg',
    content: `
**How much is mental healing at Griya Beji Bali?** Healing therapy at **[Taman Beji Griya Waterfall](/tours/griya-beji-waterfall)** is **IDR 1,500,000** per person on the 2026 park menu. The venue describes it as **guided relaxation / hypnotherapy** for stress, habit, and anxiety support. It is **not a hospital or licensed medical clinic**. **Book ahead**. Gate admission is extra. Pickup **IDR 400,000** or self-meet in Punggul.

> **Key Takeaways**
> - **IDR 1,500,000** · confirm the live board
> - Spiritual / relaxation therapy — **not** a psychiatric diagnosis
> - The park asks guests with psychosis or dissociative disorders **not** to use hypnotherapy
> - Same site as **purification IDR 300,000** and **palm reading IDR 1,000,000**
> - WhatsApp booking — **no payment to inquire**

## What to expect

You sit with a practitioner in a quiet room or pavilion. The method is closer to **focused relaxation** than to a medical procedure. Sessions are typically **60–90 minutes**. Wear comfortable temple-appropriate clothes.

This is **not** a substitute for emergency care, medication, or a clinical psychologist. If you are in crisis, seek a licensed clinician — do not book this therapy as treatment.

## Purification vs healing

| | Waterfall purification | Mental healing |
| --- | --- | --- |
| Price | **IDR 300,000** | **IDR 1,500,000** |
...
1. Open [Griya Beji Waterfall](/tours/griya-beji-waterfall)
2. WhatsApp **mental healing, date, guest count, any health notes you want the park to know**
3. We confirm practitioner availability and IDR — **no deposit to ask**

**Ready?** [Book Griya Beji](/tours/griya-beji-waterfall) · [palm reading](/blog/palm-reading-bali-griya-beji) · [vs Tirta Empul](/blog/griya-beji-vs-tirta-empul-melukat).
`,
  },
]
