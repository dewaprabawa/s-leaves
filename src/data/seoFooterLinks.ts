...
export const SEO_FOOTER_LINKS: SeoFooterLink[] = [
  ...
  { label: 'Jungle swing + cooking class', href: '/blog/swing-heaven-cooking-class-ubud' },
  { label: 'Book swing + cooking', href: '/book?activity=combo-swing-cooking' },
  { label: 'Hotel pickup explained', href: '/blog/ubud-hotel-pickup-bali-adventures-explained' },
  { label: 'Tirta Empul water purification', href: '/tours/tirta-empu-purification' },
  { label: 'Melukat ceremony Ubud guide', href: '/blog/tirta-empu-melukat-ubud-guide' },
  { label: 'Griya Beji Waterfall', href: '/tours/griya-beji-waterfall' },
  { label: 'Waterfall purification Ubud', href: '/blog/griya-beji-waterfall-ubud-guide' },
  ...
  { label: 'Ayung rafting Ubud price 2026', href: '/blog/rafting-ubud-price-2026' },
  { label: 'Canyon tubing', href: '/tours/canyon-tubing' },
  { label: 'Wos River tubing guide', href: '/blog/bali-canyon-tubing-guide-ubud' },
  { label: 'Wos River tubing price 2026', href: '/blog/wos-river-tubing-price-2026' },
