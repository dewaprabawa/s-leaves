...
export function buildOrganizationSchema() {
  return {
    ...
    legalName: SITE_NAME,
    description:
      'Bali travel activities in Pejeng near Ubud — ATV rides, whitewater rafting, canyon tubing, ricefield cycling, Mount Batur sunrise jeep (Kintamani), Tumang Bali Cooking Class, Tirta Empul or Pura Beji private melukat, coffee tasting, and private day tours. Free Ubud hotel pickup on cycling and Tumang cooking class; private shuttle on Tirta Empul / Beji purification.',
    url: SITE_URL,
