...
const BLOG_LASTMOD_OVERRIDE: Record<string, string> = {
  ...
  'swing-heaven-cooking-class-ubud': GEO_UPDATED,
  'cycling-cooking-class-ubud-full-day-itinerary': COOKING_GEO_UPDATED,
  ...
  'wos-river-tubing-price-2026': ACTIVITY_GEO_UPDATED,
  ...
  'long-private-driver-day-ubud-2026': ACTIVITY_GEO_UPDATED,
  'griya-beji-waterfall-ubud-guide': ACTIVITY_GEO_UPDATED,
  'griya-beji-vs-tirta-empul-melukat': ACTIVITY_GEO_UPDATED,
  'palm-reading-bali-griya-beji': ACTIVITY_GEO_UPDATED,
  'mental-healing-bali-griya-beji': ACTIVITY_GEO_UPDATED,
